package com.macy.consumer.dto.json;

import com.fasterxml.jackson.annotation.JsonProperty;
import com.macy.consumer.dto.OrderStatus;

import java.io.Serializable;


public class ConsumerJson implements Serializable {
    ...
    public ConsumerJson(String messageName, String imagePathname, double itemHeight, String upcList, double itemLength, String command, String itemName, String pickType, double itemWidth, String rfidTagged, String itemDescription, int storageAttribute, double itemWeight, OrderStatus orderStatus) {
